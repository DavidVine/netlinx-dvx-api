...
channel_event[dvDvxAudOutPorts,0]
{
    on:
    {
	//send_string 0, 'DEBUG::[DvxListener.axi] - channel_event[dvDvxAudOutPorts,0]'
	//send_string 0, "'    ON channel.channel = <',itoa(channel.channel),'>'"
	switch (channel.channel)
	{
	    #if_defined INCLUDE_DVX_NOTIFY_AUDIO_OUT_MUTE_CALLBACK
	    case nDVX_CHANNEL_AUDIO_OUTPUT_VOLUME_MUTE:
	    {
		//send_string 0, '      case nDVX_CHANNEL_AUDIO_OUTPUT_VOLUME_MUTE'
    ...
    {
	//send_string 0, 'DEBUG::[DvxListener.axi] - channel_event[dvDvxAudOutPorts,0]'
	//send_string 0, "'    OFF channel.channel = <',itoa(channel.channel),'>'"
	switch (channel.channel)
	{
	    #if_defined INCLUDE_DVX_NOTIFY_AUDIO_OUT_MUTE_CALLBACK
	    case nDVX_CHANNEL_AUDIO_OUTPUT_VOLUME_MUTE:
